...
public class WirelessMachines {
    ...
    public static final int[] WIRELL_ENERGY_HIGH_TIERS = GTValues.tiersBetween(IV,MAX);
    ...
    public static final MachineDefinition[] WIRELESS_ENERGY_INPUT_HATCH_64A = registerWirelessEnergyHatch(IO.IN,64,PartAbility.INPUT_ENERGY, GTValues.tiersBetween(EV, MAX));
    ...
    public static final MachineDefinition[] WIRELESS_ENERGY_OUTPUT_HATCH_64A = registerWirelessEnergyHatch(IO.OUT,64,PartAbility.OUTPUT_ENERGY, GTValues.tiersBetween(EV, MAX));
